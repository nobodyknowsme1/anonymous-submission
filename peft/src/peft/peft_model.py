...
class PeftModel(PushToHubMixin, torch.nn.Module):
    ...
    **Attributes**:
    ...
    def __init__(
        ...
        # numerical differences, [ANONYMOUS_REPO] - to avoid any unexpected
    ...
    def save_pretrained(
        ...
        **kwargs: Any,
        ...
        if selected_adapters is None:
            ...
            print(f"`save_pretrained` method called without `selected_adapters`. Saving all adapters: {selected_adapters}")
        else:
            if any(
        ...
        for adapter_name in selected_adapters:
            ...
            if is_main_process and safe_serialization:
                # Section copied from: [ANONYMOUS_REPO]
    ...
    def _setup_prompt_encoder(self, adapter_name: str):
        ...
        for named_param, value in list(transformer_backbone.named_parameters()):
            ...
            # For reference refer to issue: [ANONYMOUS_REPO]
    ...
    def load_adapter(
        ...
        **kwargs: Any,
        ...
        if (
            ...
            # `offload_index` was introduced in [ANONYMOUS_REPO]
...
class PeftModelForCausalLM(PeftModel):
    ...
    def prepare_inputs_for_generation(self, *args, task_ids: Optional[torch.Tensor] = None, **kwargs):
        ...
        # [ANONYMOUS_REPO] introduced new cache format
